//
//  ProvisionDetailsViewController.swift
//  WITankopediaKit
//
...
class ProvisionDetailsViewController: WITableViewController, TabBarItem {
    static let title = "Provision Details"
    ...
    var viewModel_: ProvisionDetailsViewModel?
    ...
    private func setup(for viewModel: ProvisionDetailsViewModel) {
        title = "\(viewModel.provision.name) Details"
    }
    ...
    public override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.setup(for: viewModel_.provision.image)
            return cell
        default:
